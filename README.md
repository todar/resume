...
This uses a component I made named `Page` that works similar to a word document. Due to this fact, this will not be a mobile-friendly app. But should print nicely to distribute to possible employers.

> Below are the notes created using `Create React App`
